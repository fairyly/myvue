...
- 添加视频链接的时候发现，富文本框中是一个图片，看到 [issue#4210](https://github.com/tinymce/tinymce/issues/4210)
  - 官方称这是一个占位图，不是bug,播放可以在预览时候，加入预览插件
  
- 添加视频不能再编辑框中播放，[issues#4916](https://github.com/tinymce/tinymce/issues/4916)，说是需要插件 [mediaembed](https://www.tiny.cloud/docs-4x/plugins/mediaembed/),
  - 安装了 4.9.6 版本，发现只有 `media` 插件，没有 `mediaembed`, 看到网站上是高级插件，收费
